...
class Person :
 ...
 public:
  ...
  const ::itheima::Info& info() const;
  ::itheima::Info* release_info();
  ::itheima::Info* mutable_info();
  void set_allocated_info(::itheima::Info* info);
...
inline const ::itheima::Info& Person::info() const {
  const ::itheima::Info* p = info_;
  // @@protoc_insertion_point(field_get:itcast.Person.info)
  return p != nullptr ? *p : *reinterpret_cast<const ::itheima::Info*>(
      &::itheima::_Info_default_instance_);
}
inline ::itheima::Info* Person::release_info() {
  // @@protoc_insertion_point(field_release:itcast.Person.info)
  
  ::itheima::Info* temp = info_;
  info_ = nullptr;
  return temp;
}
inline ::itheima::Info* Person::mutable_info() {
  
  if (info_ == nullptr) {
    auto* p = CreateMaybeMessage<::itheima::Info>(GetArenaNoVirtual());
    info_ = p;
  }
  // @@protoc_insertion_point(field_mutable:itcast.Person.info)
  return info_;
}
inline void Person::set_allocated_info(::itheima::Info* info) {
