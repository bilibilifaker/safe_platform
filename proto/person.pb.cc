...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::itcast::Person, info_),
};
...
const char descriptor_table_protodef_person_2eproto[] =
  "\n\014person.proto\022\006itcast\032\ninfo.proto\"w\n\006Pe"
  "rson\022\n\n\002id\030\001 \001(\005\022\014\n\004name\030\002 \003(\014\022\013\n\003sex\030\003 "
  "\001(\t\022\013\n\003age\030\004 \001(\005\022\034\n\005color\030\005 \001(\0162\r.itcast"
  ".Color\022\033\n\004info\030\006 \001(\0132\r.itheima.Info*%\n\005C"
  "olor\022\007\n\003Red\020\000\022\t\n\005Green\020\006\022\010\n\004Blue\020\tb\006prot"
  "o3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_person_2eproto = {
  &descriptor_table_person_2eproto_initialized, descriptor_table_protodef_person_2eproto, "person.proto", 202,
...
void Person::InitAsDefaultInstance() {
  ::itcast::_Person_default_instance_._instance.get_mutable()->info_ = const_cast< ::itheima::Info*>(
      ::itheima::Info::internal_default_instance());
}
class Person::HasBitSetters {
 public:
  static const ::itheima::Info& info(const Person* msg);
};
...
Person::Person(const Person& from)
  ...
  if (from.has_info()) {
    info_ = new ::itheima::Info(*from.info_);
  } else {
    info_ = nullptr;
  }
  ::memcpy(&id_, &from.id_,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_sex(), ptr, ctx, "itcast.Person.sex");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 age = 4;
...
// @@protoc_insertion_point(class_specific_merge_from_start:itcast.Person)
  ...
  if (from.has_info()) {
    mutable_info()->::itheima::Info::MergeFrom(from.info());
  }
  if (from.id() != 0) {
    set_id(from.id());
  }
