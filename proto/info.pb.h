...
PROTOBUF_NAMESPACE_OPEN
template<> ::itheima::Info* Arena::CreateMaybeMessage<::itheima::Info>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace itheima {
...
class Info :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:itheima.Info) */ {
 public:
  Info();
  virtual ~Info();
  ...
  // @@protoc_insertion_point(class_scope:itheima.Info)
 private:
  class HasBitSetters;
...
inline const std::string& Info::address() const {
  // @@protoc_insertion_point(field_get:itheima.Info.address)
...
inline void Info::set_address(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:itheima.Info.address)
}
inline void Info::set_address(std::string&& value) {
  
  address_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:itheima.Info.address)
}
inline void Info::set_address(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:itheima.Info.address)
}
inline void Info::set_address(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:itheima.Info.address)
}
inline std::string* Info::mutable_address() {
  
  // @@protoc_insertion_point(field_mutable:itheima.Info.address)
...
inline std::string* Info::release_address() {
  // @@protoc_insertion_point(field_release:itheima.Info.address)
...
inline void Info::set_allocated_address(std::string* address) {
  ...
  // @@protoc_insertion_point(field_set_allocated:itheima.Info.address)
}

// int32 number = 2;
inline void Info::clear_number() {
  number_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Info::number() const {
  // @@protoc_insertion_point(field_get:itheima.Info.number)
  return number_;
}
inline void Info::set_number(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  number_ = value;
  // @@protoc_insertion_point(field_set:itheima.Info.number)
}
